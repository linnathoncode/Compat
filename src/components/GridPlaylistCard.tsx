...
export const GridPlaylistCard = ({ data, source, children }: BaseProps) => {
  return (
    <div className="relative flex w-full flex-col items-start gap-4 rounded-lg border border-purple-950 bg-[#1e152c] p-6 shadow-md">
      {children}
      {data.imageUrl && (
        <img
          src={data.imageUrl}
